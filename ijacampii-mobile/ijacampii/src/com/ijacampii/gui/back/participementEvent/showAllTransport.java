 ...
 * @author user
 */
public class showAllTransport extends Form{
    
      public static MoyenTransport currentParticipementEvent = null;
    Form previous;
    Button addBtn;
    ...
    public showAllTransport(Form previous) {
    ...
    private void addGUIs() {
        ...
        ArrayList<MoyenTransport> listParticipementEvents = MoyenTransportService.getInstance().getAll();


        if (listParticipementEvents.size() > 0) {
            for (MoyenTransport participementEvent : listParticipementEvents) {
    ...
    private Container makeModelWithoutButtons(MoyenTransport MoyenTransport) {
  ...
  //      utilisateursLabel.setUIID("labelDefault");
        ...
        nbrParticipementLabel = new Label("type : " + MoyenTransport.getType());
   ...
   //     evenementLabel.setUIID("labelDefault");
    ...
    private Component makeParticipementEventModel(MoyenTransport participementEvent) {
