...
import com.ijacampii.services.EquipementService;
 ...
 * @author user
 */
public class showAllEquipement extends Form {
    
      public static Equipement currentParticipementEvent = null;
    Form previous;
    Button addBtn;
    ...
    public showAllEquipement(Form previous) {
    ...
    private void addGUIs() {
        ...
        ArrayList<Equipement> listParticipementEvents = EquipementService.getInstance().getAll();


        if (listParticipementEvents.size() > 0) {
            for (Equipement participementEvent : listParticipementEvents) {
    ...
    private void addActions() {
        addBtn.addActionListener(action -> {
            ...
            new EquipementAjout(this).show();
        });

    }

    private Container makeModelWithoutButtons(Equipement equipement) {
  ...
  //      utilisateursLabel.setUIID("labelDefault");
        ...
        nbrParticipementLabel = new Label("Nom : " + equipement.getNom());
   ...
   //     evenementLabel.setUIID("labelDefault");
    ...
    private Component makeParticipementEventModel(Equipement participementEvent) {
